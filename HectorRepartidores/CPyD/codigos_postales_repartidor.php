    ...
    <nav class="container">
        ...
        <div id="formularioAgregar" style="display:none;">
            ...
            <form onsubmit="agregarCodigoPostal(event)">
                ...
                <label for="cobro-base">Cobro base:</label><br>
                <input type="number" id="cobro-base" name="cobro-base" min="50" max="100" required><br><br>
        ...
        <div id="formularioEditar" style="display:none;">
            ...
            <form onsubmit="guardarEdicionCodigoPostal(event)">
                ...
                <input type="number" id="editar-cobro-base" name="cobro-base" min="50" max="100" required><br><br>
...
<script>
    ...
    function agregarCodigoPostal(event) {
        ...
        const cobroBase = document.getElementById('cobro-base').value;
        ...
        document.getElementById('cobro-base').value = '';
    }
